    ...
    <div class="container750 user-profile-wrapper mt-0 mt-md-5" id="myTabContent">
      <div class="edit-profile position-relative">
         ...
         <div class="container300">
               <h1 class="h3 text-center mt-2 mb-3">Add profile</h1>
               
               <!--- Register form start --->
                {!! Form::open(['url' => 'save-profile-member', 'class'=>'login-signup-form', 'id'=>'addprofileForm', 'files' => true, 'method'=>'post']) !!}
                    <label class="label-title w-100">Name</label>
                    <div class="form-group mt-2 position-relative">
                        <input id="firstName" placeholder=" "  type="text" class="form-control" name="firstName" value="{{ old('firstName') }}" required autocomplete="off" autofocus>
                    ...
                    <div class="form-group mt-2 mb-4 position-relative">
                        <input id="lastName" placeholder=" "  type="text" class="form-control" name="lastName" value="{{ old('lastName') }}" required autocomplete="off" autofocus>
                    ...
                    <div class="form-group mb-4">
                        ...
                        @if(!empty($genderOptions))
                            @foreach($genderOptions as $value)
                                <input type='radio' id="{{$value['name']}}" value="{{$value['id']}}" {{ old('gender') == $value['id'] ? 'checked' : ''}} name='gender'>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input class="form-control pl-3" type="text" id="dateOfBirth" name="dateOfBirth" value="" autocomplete="off">
                    </div>
                    ...
                    @if($availableCount == '0')
                        <div class="form-group d-none">
                            <p>Additional charges @ $9 / annually will be added to your billing cycle.</p>
                            <div class="input-group coupon-input coupon-profile d-none"> 
                                <input type="text" class="form-control coupon d-none" name="" placeholder="Promo Code (Optional)"> <span class="input-group-append"> <button class="btn-coupon">Apply</button> </span> 
                            </div>
                            <span class="code-green d-none">Promo Code Applied!</span> 
                        </div>
                    @endif
